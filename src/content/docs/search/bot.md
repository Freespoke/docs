...
```
Mozilla/5.0 (compatible; FreespokeCrawler/2.0; +https://crawler.freespoke.com)
```
...
at `mysite.com/robots.txt`), and add a rule for `User-agent: FreespokeCrawler`:

```
User-agent: FreespokeCrawler
